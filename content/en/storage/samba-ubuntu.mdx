...
Check listeners and firewall:
```bash
ss -tulpn | grep -E ':445|:139' || sudo netstat -tulpn | grep -E ':445|:139'
...
sudo tar -xzf /backups/samba-YYYY-MM-DD.tgz -C /
...
What this does: Archives/restores config and data with minimal downtime.
